...
func (w Walking) Calories() float64 {
	...
	speedSquare := math.Pow(metersPerSecond, 2)
	calories := ((CaloriesWeightMultiplier*w.Weight + (speedSquare/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
	return calories
}
